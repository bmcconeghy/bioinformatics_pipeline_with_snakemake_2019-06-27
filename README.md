...
Most of this course is based on the snakemake tutorial found on snakemake's readthedocs page: [snakemake tutorial](https://snakemake.readthedocs.io/en/stable/tutorial/tutorial.html)
## Prerequisites
